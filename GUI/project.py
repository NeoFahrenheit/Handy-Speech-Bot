...
class Project(wx.Frame):
    def __init__(self, parent: wx.Window, sanitized_name: str, path: str):
        ...
        """        
        super().__init__(parent, title=sanitized_name, size=(900, 750))
    ...
    def _init_ui(self):
        ...
        self.info_lc.InsertItem(4, 'Inserted on')
        self.info_lc.InsertItem(5, 'Source')
        self.info_lc.InsertItem(6, 'Model')
        self.info_lc.InsertItem(7, 'Database')

        files_box = wx.BoxSizer(wx.VERTICAL)
        files_box.Add(self.files_lc, proportion=2, flag=wx.EXPAND)
        files_box.Add(self.info_lc, proportion=1, flag=wx.TOP | wx.EXPAND, border=10)

        chat_box = wx.BoxSizer(wx.VERTICAL)
        chat_box.Add(self.chat_rt, proportion=1, flag=wx.EXPAND)
        chat_box.Add(self.input_tc, flag=wx.EXPAND | wx.TOP, border=5)
        ...
        vbox.Add(top_box, proportion=3, flag=wx.EXPAND)
